      ...
      <div className="email-page__content">
        ...
        {showModal && (
          <div className="email-page__modal">
            <div className="modal-wrapper" role="dialog" aria-labelledby="modal-heading-01" aria-modal="true" aria-describedby="modal-content-id-1">
              <div className="modal-wrapper__close-button-grid">
                <div className="modal-wrapper__close-button-grid__close-container" onClick={closeModal}>
                  <div className="modal-wrapper__close-button-grid__close-container__close-icon"></div>
                  <div className="modal-wrapper__close-button-grid__close-container__close-icon"></div>
                </div>
              </div>

              <div className="modal-wrapper__content">Thank you for your message!</div>

              <footer className="modal-wrapper__footer">
                <button className="modal-wrapper__footer__cancel-button" onClick={closeModal}>Close</button>
              </footer>
            </div>
          </div>
        )}
